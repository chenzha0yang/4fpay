...
export default {
  ...
  methods: {
    ...
    sendUpdateDataCallback(data) {
      modifyStatusCallback("_putbank", "outcomeBankList", data, this.current);
    },
    // 删除
    ...
    addNew() {
      this.$router.push({ name: "addOutBank" });
    },
