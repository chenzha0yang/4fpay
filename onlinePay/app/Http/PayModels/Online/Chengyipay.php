...
class Chengyipay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['pay_md5sign']     = self::getMd5Sign("{$signStr}&key=", $payConf['md5_private_key']);
        $data['pay_md5sign'] = strtoupper($data['pay_md5sign']);
        $data['pay_productname'] = $order;
        $data['pay_attach']      = "huang001";
