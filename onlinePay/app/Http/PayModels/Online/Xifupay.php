...
class Xifupay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['payerIp'] = '127.0.0.1'; //支付端ip
        $data['sign'] = self::getMd5Sign("{$signStr}", $payConf['md5_private_key']);
        $signStrs = self::getSignStr($data, false);
        $data['signs'] = self::getMd5Sign("{$signStrs}", $payConf['md5_private_key']);
