...
class Dingshengtwopay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        //提取四方域名
        $url = parse_url($reqData['formUrl']);
        self::$domain = 'http://'.$url['host'];
    ...
    public static function getQrCode($response){
        ...
        if(isset($res['url']) && $res['code'] == 200) {
            $res['payurl'] = self::$domain . $res['url'];
        }
        return $res;
    }
