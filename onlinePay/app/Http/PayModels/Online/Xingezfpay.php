...
class Xingezfpay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['sign']         = self::sign($payConf['md5_private_key'], array('amount' => $data['amount'], 'out_trade_no' => $data['out_trade_no']));
    ...
    public static function SignOther($model, $data, $payConf)
    {
        ...
        if ($payConf['md5_private_key'] == $data['account_key']) {
            if (self::sign($payConf['md5_private_key'],$signArr) == $data['sign']) {
                return true;
            } else {
                return false;
            }
