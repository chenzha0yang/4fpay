...
class Yongrzfvpay extends ApiModel
{
    ...
    public static function getQrCode($response)
    {
        ...
        if($responseData['dealCode'] == '10000'){
            $responseData['codeUrl'] = $responseData['codeUrl'];
        }
    ...
    public static function SignOther($mod, $data, $payConf)
    {
        ...
        if (strtoupper($sign) == strtoupper($signTrue) && $data['dealCode'] = '10000') {
            return true;
        }
        return false;
    }
