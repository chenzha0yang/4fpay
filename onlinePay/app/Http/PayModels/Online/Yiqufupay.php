...
class Yiqufupay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data           = array(
            ...
            'subMchId'    => '',
            'outTradeNo'  => $payConf['business_num'] . $order,
            'body'        => 'goodsName',
            'totalFee'    => $amount * 100,
            'payType'     => $bank,
            'payMode'     => 'perCode',
    ...
    {
        $res['outTradeNo'] = str_replace($request->all()['merchantId'],'', $request->all()['outTradeNo']);
        $res['totalFee']   = $request->all()['totalFee'] / 100;
