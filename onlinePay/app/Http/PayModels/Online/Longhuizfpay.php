...
class Longhuizfpay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['tradeNo'] = $order;//订单号
        $data['fee'] = $amount;//订单金额
        $data['retUrl'] = $returnUrl;
        $data['errorUrl'] = $returnUrl;
        $data['notifyUrl'] = $ServerUrl;
        $data['ext'] = 'test';
        $signStr =  $data['mchId'].'&'.$data['tradeNo'].'&'.$data['fee'].'&'.$data['notifyUrl'];
    ...
    public static function SignOther($type, $data, $payConf)
    {
        ...
        unset($data['sign']);
        unset($data['ext']);
        $signStr =  $data['mchId'].'&'.$data['tradeNo'].'&'.$data['fee'].'&'.$data['state'];
