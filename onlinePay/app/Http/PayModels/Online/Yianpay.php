...
class Yianpay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['paymoney'] = sprintf("%1\$.2f",$amount);                                 //金额
        ...
        $data['attach'] = $order;                                                       //备注信息
        $data['sign'] = self::getMd5Sign("{$signStr}", $payConf['md5_private_key']);    //MD5 签名
        unset($reqData);
        return $data;
    }
}