...
class Shoupay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['transNo']        = $order; //订单
        $data['payWay']         = $bank; //支付方式
        $data['tradeName']      = 'vivo'; //商品名称
    ...
    public static function SignOther($type, $data, $payConf)
    {
        ...
        $signTrue = strtoupper(md5($md5str . '&' . $payConf['md5_private_key']));
        if (strtoupper($sign) == strtoupper($signTrue)  && $data['transStatus'] == '1') {
            return true;
        }
        return false;
    }
