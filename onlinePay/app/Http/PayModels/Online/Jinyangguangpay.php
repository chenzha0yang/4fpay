...
class Jinyangguangpay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data = array(
            'notify_url'  =>  $ServerUrl,           //成功后通知的地址
            'return_url'  =>  $returnUrl,           //同步通知地址
            'user_account' => $payConf['business_num'], //商户ID
            'out_trade_no'  => $order,              //订单号
            'payment_type'  => $bank,           //支付类型
            'total_fee'   => $amount,           //金额
            'trade_time'  => date('Y-m-d H:i:s'),   //下单时间
            'body'      => 'miaosu',        //订单描述
        );
