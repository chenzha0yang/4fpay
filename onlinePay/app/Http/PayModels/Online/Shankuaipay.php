...
class Shankuaipay extends ApiModel
{
    ...
    public static function getAllInfo($reqData, $payConf)
    {
        ...
        $data['pay_md5sign']     = strtoupper(self::getMd5Sign($str . '&key=', $payConf['md5_private_key']));
    ...
    public static function SignOther($type, $data, $payConf)
    {
        ...
        unset($data['sign']);
        $str    = self::getSignStr($data, true, true);
        $mySign = strtoupper(self::getMd5Sign($str . '&key=', $payConf['md5_private_key']));
