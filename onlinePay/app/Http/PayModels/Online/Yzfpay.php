...
class Yzfpay extends ApiModel
{
    ...
    public static function getQrCode($res)
    {
        ...
        if (isset($data['messages']) && $data['messages']['returncode'] == 'SUCCESS') {
            $data['returncode'] = $data['messages']['returncode'];
            $data['returnmsg']  = $data['messages']['returnmsg'];
            unset($data['messages']);
        }
        return $data;
    }
    ...
    public static function SignOther($model, $data, $payConf)
    {
        ...
        if ($mySign == strtoupper($data['sign'])) {
            return true;
        } else {
            return false;
        }
