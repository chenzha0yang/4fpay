...
class Jiefuzfpay extends ApiModel
{
    ...
    public static function getQrCode($res)
    {
        ...
        if ($arr['status'] == 'success') {
            $returnData['status'] = $arr['status'];
            $returnData['pay_url'] = $arr['pay_url'];
        } else {
            $returnData['status'] = $arr['status'];
